var npcScooter1, npcScooter2, npcScooter3, npcScooter4;
		...
		for (let rowIndex = 0; rowIndex < NUMBER_OF_ROWS; rowIndex++)
		{
			for (let columnIndex = 0; columnIndex < NUMBER_OF_COLUMNS; columnIndex++)
			{
				...
				if (trackGrid.grid[arrayIndex] === this.startingTile)
				{
					...
					console.log('this.startingTileX: ' + this.startingTileX);
					console.log('this.startingTileY: ' + this.startingTileY);
					trackGrid.grid[arrayIndex] = this.tileUnderStartingTile;
					console.log('this.startingTile: ' + this.startingTile);

					this.centerX = this.startingTileX + TRACK_WIDTH/2;
					this.centerY = this.startingTileY + TRACK_HEIGHT/2;

					this.updateProperties();
					console.log('this.startingDrawX: ' + this.startingDrawX);
					console.log('this.startingDrawY: ' + this.startingDrawY);	
				}
			}
		}
	}
